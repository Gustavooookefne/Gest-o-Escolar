...
public class AlunoRepository {
    ...
    public Aluno buscarPorEmail(String email)throws SQLException{
        ...
        PreparedStatement ps = conn.prepareStatement(sql)){
            ...
            if (rs.next()) {
                ...
                aluno.setEmail(rs.getString("email"));
                aluno.setMatricula(rs.getInt("matricula"));
                aluno.setDataNacimento(rs.getString("data_nascimento"));
                return aluno;
            }
        }
        return null;
    ...
    public Aluno buscarPorEmial(String email)throws SQLException{

        return null;
    }

    public Aluno atualizarAluno(Aluno alunoExistente) {
